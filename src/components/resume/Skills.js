          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                className="w-full h-full bg-gradient-to-r from-blue-600 via-ping-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[90%] h-full bg-gradient-to-r from-blue-600 via-ping-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[70%] h-full bg-gradient-to-r from-blue-600 via-ping-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[75%] h-full bg-gradient-to-r from-blue-600 via-ping-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[80%] h-full bg-gradient-to-r from-blue-600 via-ping-500 to-red-500 rounded-md relative"
              >
